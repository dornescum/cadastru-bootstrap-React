...
const Salaci = () => {
    return <Row className="mt-5 mb-2">
        <div className="col-lg-6 margin-50px-bottom text-center mobile-padding-15px-lr">
            <p className="mr-1 ml-1 mt-2 grey-color-font font-size16">
            ...
            <p className="ml-3 mr-3 grey-color-font font-size16">
...
const Dan = () => {
    return <Row>
        <div className="col-md-6 xs-margin-20px-bottom mb-3">
                <div className="card-list-img">
        ...
        <div className="col-lg-6 text-dark margin-50px-bottom text-center">
            <p className="ml-3 mr-3 mt-3 grey-color-font font-size16">
